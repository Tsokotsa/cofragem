...
<div id="kt_content_container" class="container-fluid">
    ...
    <div class="row gy-5 g-xl-8">
        ...
        <div class="col-xl-4">
            ...
            <!--layout-partial:partials/widgets/statistics/_widget-5.blade.php-->
    ...
    <div class="row gy-5 g-xl-8">
        ...
        <div class="col-xl-4">
            ...
            <!--layout-partial:partials/widgets/mixed/_widget-3.blade.php-->
        ...
        <div class="col-xl-4">
            ...
            <!--layout-partial:partials/widgets/mixed/_widget-4.blade.php-->
        ...
        <div class="col-xl-4">
            ...
            <!--layout-partial:partials/widgets/mixed/_widget-5.blade.php-->
    ...
    <div class="row gy-5 g-xl-8">
        ...
        <div class="col-xxl-4">
            ...
            <!--layout-partial:partials/widgets/lists/_widget-9.blade.php-->
        ...
        <div class="col-xxl-8">
            ...
            <!--layout-partial:partials/widgets/tables/_widget-9.blade.php-->
    ...
    <div class="row g-5 g-xl-8">
        <div class="col-xl-4">
            ...
            <!--layout-partial:partials/widgets/lists/_widget-4.blade.php-->

        </div>
        <div class="col-xl-4">

            <!--layout-partial:partials/widgets/lists/_widget-5.blade.php-->

        </div>
        <div class="col-xl-4">

            <!--layout-partial:partials/widgets/lists/_widget-3.blade.php-->
    ...
    <div class="g-5 gx-xxl-8">
        ...
        <!--layout-partial:partials/widgets/tables/_widget-10.blade.php-->
