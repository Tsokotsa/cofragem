...
<div class="d-flex align-items-stretch flex-shrink-0">
    ...
    <div class="d-flex align-items-stretch ms-1 ms-lg-3">
        ...
        <!--layout-partial:layout/search/_base.blade.php-->
    ...
    <div class="d-flex align-items-center ms-1 ms-lg-3">
        ...
        <!--layout-partial:layout/topbar/partials/_quick-links-menu.blade.php-->
    ...
    <div class="d-flex align-items-center ms-1 ms-lg-3">
        ...
        <!--layout-partial:layout/topbar/partials/_notifications-menu.blade.php-->
    ...
    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
        ...
        <!--layout-partial:layout/topbar/partials/_user-menu.blade.php-->
